...
<body onload="mudarposition()">
  ...
  <div class="container">
    ...
    <form class="form" action="TelaUsuario.html" method="post">
      <input 
     placeholder="E-mail ou CPF" id="emailCpf" name="emailCpf" type="text" class="input" required pattern="(^\d{3}\.\d{3}\.\d{3}-\d{2}$)|(^\d{11}$)|(^[^\s@]+@[^\s@]+\.[^\s@]+$)"
